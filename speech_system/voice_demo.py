...
def voice_demo():
    ...
    print("Welcome to the AI Agent Voice Demo")
    print("==================================")
    ...
    examples = [
        "Hello! I'm your AI assistant with voice capabilities.",
        "I can speak with different tones and styles based on the situation.",
        "My voice is designed to be professional yet approachable.",
        "Thanks for trying out my voice system. Have a great day!"
    ]
